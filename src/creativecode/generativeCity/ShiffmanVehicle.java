...
class ShiffmanVehicle {
    ...
    ShiffmanVehicle(PVector l, float ms, float mf) {
        location = l.get();
        r = 12;
        maxspeed = ms;
        maxforce = mf;
    ...
    void applyBehaviors(ArrayList vehicles, ShiffmanPath path) {
        // Follow path force
    ...
    PVector separate(ArrayList boids) {
        ...
        for (int i = 0; i < boids.size(); i++) {
            ShiffmanVehicle other = (ShiffmanVehicle) boids.get(i);
