...
public class PathFinderExample extends PApplet {
    ...
    public void setup() {
        ...
        smooth();
        ellipseMode(CENTER);
        backImage = loadImage("pathfinder/backimage.jpg");
        ...
        graphImage[graphNo] = loadImage("pathfinder/map03.png");
        ...
        graphNo = 1;
        nodeSize[graphNo] = 10.0f;
        graphImage[graphNo] = loadImage("pathfinder/maze2.png");
        gs[graphNo] = new Graph();
        ...
        graphNo = 2;
        nodeSize[graphNo] = 10.0f;
        graphImage[graphNo] = loadImage("pathfinder/map1a.png");
        PImage costImg = loadImage("pathfinder/map1b.png");
        gs[graphNo] = new Graph();
        ...
        graphImage[graphNo] = loadImage("pathfinder/mearth.jpg");
        gs[graphNo] = new Graph();
        makeGraphFromFile(gs[graphNo], "pathfinder/mearth.txt");
        gNodes = gs[graphNo].getNodeArray();
        start[graphNo] = 107;
        end[graphNo] = 106;
        gs[graphNo].compact();
